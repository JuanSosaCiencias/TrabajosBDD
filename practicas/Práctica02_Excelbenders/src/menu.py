    ...
    while True:
        ...
        if opcion == 1:
            ...
            if entidad == 'atletas':
                ...
                nacionalidad= validar_nacionalidad("Ingrese la nueva nacionalidad del atleta: ")
                sexo = seleccionar_sexo()
                ...
                nacionalidad= validar_nacionalidad("Ingrese la nueva nacionalidad del entrenador: ")
                sexo = seleccionar_sexo()
