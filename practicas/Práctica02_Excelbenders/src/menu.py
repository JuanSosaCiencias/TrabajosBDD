...
def menu_principal():
    ...
    while True:
        ...
        if opcion == 1:
            ...
            if entidad == 'atletas':
                nombre = ("Ingrese el nuevo nombre del atleta: ")
                apellido_paterno = ("Ingrese el nuevo apellido paterno del atleta: ")
                apellido_materno = ("Ingrese el nuevo apellido materno del atleta: ")
                sexo = seleccionar_sexo()
                ...
                nombre = ("Ingrese el nuevo nombre del entrenador: ")
                apellido_paterno = ("Ingrese el nuevo apellido paterno del entrenador: ")
                apellido_materno = ("Ingrese el nuevo apellido materno del entrenador: ")
                sexo = seleccionar_sexo()
                fecha_nacimiento = validar_fecha("Ingrese la nueva fecha de nacimiento del entrenador (YYYY-MM-DD): ")
                correo= validar_formato_correo("Ingrese el nuevo correo del atleta: ")
                telefono= validar_numero("Ingrese el nuevo número telefónico del atleta: ")
