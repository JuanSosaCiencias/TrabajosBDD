\begin{titlepage}
	...
	\begin{minipage}[c][0.81\textheight][t]{0.75\textwidth}
		\begin{center}
			...
			\textsc{\LARGE \textbf{T}\hspace{1cm}\textbf{A}\hspace{1cm}\textbf{R}\hspace{1cm}\textbf{E}\hspace{1cm}\textbf{A}\hspace{1.3cm}\textbf{5}}\\[2cm]
			\textsc{\Large{Equipo:}\normalsize \\
                \vspace{.3cm}
			...
			\textsc{{Fecha de entrega: \\ \textbf{5 de Noviembre de 2024}}}\\[0.5cm]        
